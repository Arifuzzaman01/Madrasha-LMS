...
const Btn = ({ text, href }) => {
  return (
    <div className="relative inline-block overflow-hidden rounded-full group">
      <Link
        href={href}
        className="relative z-10 flex items-center gap-2 px-8 py-4 bg-emerald-700 text-white font-bold shadow-lg shadow-emerald-200 active:scale-95 transition-all duration-300"
      >
        {/* টেক্সট এবং আইকন z-10 এ থাকায় শ্যাটারের উপরে থাকবে */}
